...
const findChannelDetailsInOutput =
  exportedForTesting.findChannelDetailsInOutput;
...
describe('ChannelsService', () => {
  ...
  test('should return channel', () => {
    ...
    return getChannelByApplicationId(apiClient, '1234abcd', {
      ...
      expect(channel.releaseSequence).toEqual(
        expectedChannels.channels[0].releaseSequence
      );
    });
  });
});
