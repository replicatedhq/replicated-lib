...
const reportCompatibilityResultByAppId =
  exportedForTesting.reportCompatibilityResultByAppId;
...
describe('ReleasesService', () => {
  ...
  test('report compatibility results', () => {
    ...
    return reportCompatibilityResultByAppId(
      apiClient,
      '1234abcd',
      1,
      c11yResult
...
describe('isReleaseReadyForInstall', () => {
  ...
  it('chart with status unknown', async () => {
    ...
    const ready: boolean = await isReleaseReadyForInstall(
      apiClient,
      '1234abcd',
      1
    );
...
describe('createReleaseFromChart', () => {
  ...
  it('create a new release with a helm chart', async () => {
    ...
    const release: Release = await createReleaseFromChart(
      apiClient,
      'app-1',
      tempFilePath
    );
