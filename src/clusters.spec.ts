...
describe('ClusterService use cases', () => {
    ...
    test('should return cluster with tags', async() => {
        ...
        const cluster: Cluster = await createCluster(apiClient, "cluster1", "kind", "v1.25.1", "10m",
    ...
    test('should return cluster with nodegroups', async() => {
        ...
        const cluster: Cluster = await createCluster(apiClient, "cluster1", "eks", "v1.29", "10m",
