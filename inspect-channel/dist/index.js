...
exports.findChannelDetailsInOutput = exports.getChannelDetails = exports.Channel = void 0;
...
function findChannelDetailsInOutput(channels, channelName) {
    return __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __nccwpck_require__(186);
const channels_1 = __nccwpck_require__(415);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const channel = yield (0, channels_1.getChannelDetails)(core.getInput('replicated-app'), core.getInput('channel-name'));
