...
describe('Create Customer', () => {
    ...
    it('create a new customer for testing', async () => {
        ...
        await mockServer
            .forPost('/customer')
            .thenReply(201, JSON.stringify(customerResponse));
        await mockServer
            .forGet('/app/1234abcd/customer/5678efgh/license-download')
            .thenReply(403);
        const customer = await (0, customers_1.createCustomer)(apiClient, 'app-1', 'testing', 'testing@replicated.com', 'test', '', 0);
